...
exports.Tracer = exports.defaultConfig = void 0;
...
var Tracer = /** @class */ (function () {
    ...
    Tracer.prototype.write = function (action, logData, writeContext) {
        ...
        if (data === null || data === void 0 ? void 0 : data.args)
            data.args = logger_1.Logger.simplifyArgs(data.args, this.config.excludeClasses);
        writeContext.log({
            action: action,
...
exports.default = getDefaultTracer;
