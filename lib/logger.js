...
exports.Logger = exports.LOGGER = exports.defaultConfig = exports.ExcludeClasses = void 0;
var tracer_1 = __importDefault(require("./tracer"));
var jaeger_client_1 = require("jaeger-client");
var _ = __importStar(require("lodash"));
exports.ExcludeClasses = ['Transaction', 'Logger'];
exports.defaultConfig = {
    excludeClasses: exports.ExcludeClasses,
    consoleDepth: 3,
};
...
var Logger = /** @class */ (function () {
    function Logger(serviceName, options) {
        ...
        this.tracer = (0, tracer_1.default)();
    ...
    Logger.prototype.getSubLogger = function (name, parentContext) {
        ...
        return new Logger(name, { parentContext: parentContext });
    };
    /**
