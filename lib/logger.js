...
var Logger = /** @class */ (function () {
    ...
    function Logger(serviceName, options) {
         ...
         */
        this.wrapCall = function (contextName, parentLogger, func) {
            var args = [];
            for (var _i = 3; _i < arguments.length; _i++) {
                args[_i - 3] = arguments[_i];
            }
            contextName = contextName !== null && contextName !== void 0 ? contextName : func.name;
            var subLogger = parentLogger.getSubLogger(contextName, parentLogger.context);
            try {
                subLogger.info('request', { action: func.name, data: { args: args } });
                var response_1 = func.apply(_this, args);
                Promise.resolve(response_1).then(function (data) {
