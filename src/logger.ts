...
export default class Logger {
   ...
   */
  public static replacePropertiesRecursive(oldObject: any, searchKey: string, newValue: string, depth = 5): unknown {
    if (depth <= 0 || _.isObject(oldObject) !== true) return oldObject;
